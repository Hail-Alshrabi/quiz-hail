...
class AppColor{
  // primary color
  //static const PrimaryColor = Color(0xFF102770); // color name : Gossamer Color(0x0d9682)
  static const PrimaryColor = Color(0xFFD6B232); // color name : Gossamer Color(0x0d9682)
